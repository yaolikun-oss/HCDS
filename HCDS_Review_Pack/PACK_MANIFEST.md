# HCDS Review Pack Manifest

## Files Created

- `HCDS_Review_Pack/PACK_MANIFEST.md`
- `HCDS_Review_Pack/ai_agents/decisions.md`
- `HCDS_Review_Pack/ai_agents/inbox/README.md`
- `HCDS_Review_Pack/ai_agents/status.md`
...
- `HCDS_Review_Pack/entities/Costume_Spec.md`
- `HCDS_Review_Pack/entities/Expression_Spec.md`
- `HCDS_Review_Pack/entities/Pose_Action_Spec.md`
- `HCDS_Review_Pack/schema/Controlled_Vocabulary_Spec.md`
- `HCDS_Review_Pack/schema/Dataset_Master_Spec.md`
- `HCDS_Review_Pack/schema/Field_Model_Spec.md`
- `HCDS_Review_Pack/schema/HCDS_Schema.md`
- `HCDS_Review_Pack/status_snapshot.md`
